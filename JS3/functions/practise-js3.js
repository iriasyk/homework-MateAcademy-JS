...
for (; i< 10; i ++) {
    console.log(i) //undefined - нет тут выведуться числа от 0 до 9
}
...
// А где умножения на 2 если число четное?
...
// в задании написано:  которая объединит уникальные элементы всех массивов, переданных ей параметром. - тут ты берешь массивы обьявленные вне функции - они должны передаваться цфункции как параметры
...
// реализация может и правильная - но мы не учили метки и это устаревший способ - его лучше не использовать 
